# -*- coding: utf-8 -*-
"""
Created on Mon May 30 13:26:18 2022
...
y_pred =regression.predict(([[6.5]])) #polinómico



#Visualización de los datos del modelo polinómico
X_grid = np.arange(min(X), max(X), 0.01) #para aumentar la cantidad de puntos qy no parazacan recatas las lineas de la curva
